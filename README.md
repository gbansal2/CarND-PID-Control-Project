...
I gain is the integral control and this helps detect bias in the control, and correct this bias using an intergral error metric over time.
D is the differential control. This helps to smooth out any oscillations caused in the P controller.

I mainly used the P and D controllers. I gain was set to a small value which seem to work well, but I didn't have to tune the I gain a lot. 
